...
struct SymbolEntry_tag {
   ...
   union {                            /* Ανάλογα με τον τύπο εγγραφής: */
      ...
      struct {                                /******* Συνάρτηση *******/
         ...
         Stype          resultType;            /* Τύπος αποτελέσματος   */
...
extern const Stype typeVoid;
extern const Stype typeInteger;
extern const Stype typeBoolean;
extern const Stype typeChar;
extern const Stype typeReal;
